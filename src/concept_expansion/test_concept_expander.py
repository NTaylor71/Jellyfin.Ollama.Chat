...
from src.concept_expansion.concept_expander import get_concept_expander, ExpansionMethod
...
async def main():
    ...
    try:
        ...
        print("\n🎉 All tests completed!")
        print("\n📋 Next steps:")
        print("   1. Run this test with: python -m src.concept_expansion.test_conceptnet")

...
class Settings(BaseSettings):
    ...
    FAISS_BACKUP_INTERVAL: int = Field(default=3600)
    ...
    PLUGIN_RELOAD_INTERVAL: int = Field(default=5)
    ...
    WORKER_RETRY_DELAY: int = Field(default=5)
    

    WORKER_CPU_CORES: int = Field(default=3)  
    WORKER_GPU_COUNT: int = Field(default=1)  
    WORKER_MEMORY_MB: int = Field(default=8192)

#!/usr/bin/env python3
"""
CLI test script for SUTimeTemporalPlugin.
...
class SUTimeTemporalTest(PluginTestCLI):
    """Test SUTimeTemporalPlugin via queue system."""
    
    def __init__(self):
        super().__init__(
            plugin_name="SUTimeTemporalPlugin",
...
async def main_async():
    ...
    parser = create_base_parser(
        plugin_name="SUTimeTemporalPlugin",
        description="Test SUTime temporal analysis via queue system"
    )
    
    parser.add_argument(
        "text",
        nargs="?",
        help="Text to analyze for temporal expressions (e.g., 'The sequel came out three years later in 1999')"
    )
    ...
    test_client = SUTimeTemporalTest()
    ...
    if not args.text:
        ...
        print("Usage: python sutime_temporal_endpoint_test.py 'The sequel came out three years later in 1999'")
        return
    ...
    print(f"🧪 Testing SUTimeTemporalPlugin")

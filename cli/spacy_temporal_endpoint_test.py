#!/usr/bin/env python3
"""
CLI test script for SpacyTemporalPlugin.
...
class SpacyTemporalTest(PluginTestCLI):
    """Test SpacyTemporalPlugin via queue system."""
...
async def main_async():
    ...
    parser = create_base_parser(
        plugin_name="SpacyTemporalPlugin",
        description="Test SpaCy temporal analysis via queue system"
    )
    
    parser.add_argument(
        "text",
        nargs="?",
        help="Text to analyze for temporal expressions (e.g., 'Released in 1995, this movie was set in the 1980s')"
    )
    ...
    if not args.text:
        ...
        print("Usage: python spacy_temporal_endpoint_test.py 'Released in 1995, this movie was set in the 1980s'")
        return
    ...
    print(f"🧪 Testing SpacyTemporalPlugin")
